...
document.addEventListener("DOMContentLoaded", () => {
    ...
    function initPathwayVisualization() {
        ...
        const storyContent = [
            ...
            { text: "另一方面，被停飞的学员也能选择转向其他的专业。在中飞院提供的转专业方案中，被停飞学员可以根据专业成绩选择包括航空物流、航空管理、地面服务专业在内的地面专业进行学习，从而继续留在民航业内。但是对于被停飞学员来说，时间是这条路上最大的阻碍，选择转地面专业意味着再次从大一开始学习，这对于已经因为疫情耽误两年的学员来说成本太大。", imgId: "#pathway-img-2" },
